...
def generateSummary():
    ...
    for idx, paper in enumerate(papersToParse):
        try:
            ...
            result = ''.join(model(parsedTxt, min_length=60, max_length = 150))
            with open('/scratch/nr2387/Data-4/XLNET-1/'+paper, "w+") as output:
                    output.write(result)
            if idx%500 == 0:
...
def computeScore():
    ...
    generated_dir = "/scratch/nr2387/Data-4/XLNET-1/"
    ...
    for filename in os.listdir(generated_dir):
        ...
        try:
           ...
           # bleu_per = sentence_bleu([gold], generated)
            ...
            with open ("/scratch/nr2387/Data-4/Accuracy/ErrorXLNET.txt", "a+") as fp:
   ...
   # resList['scores']={'Rouge Score': total_2/count, 'Bleu Score':corpus_bleu(gold_list, generated_list)}
    ...
    with open("/scratch/nr2387/Data-4/XLNet.json", "w+") as fp:
